...
var menu = function menu() {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.burger').on('click', openMenu);
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.mobile-menu__close').on('click', closeMenu); //аккордион в мобильном меню
